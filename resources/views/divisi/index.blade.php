                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="/divisi/{{ $d->kode_divisi }}/delete"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="kode_divisi" class="form-control"
                                        name="kode_divisi" placeholder="Kode Divisi">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_divisi" class="form-control"
...
@push('myscript')
    <script>
        $(function() {
            ...
            $(".edit").click(function() {
                var kode_divisi = $(this).attr('kode_divisi');
                $.ajax({
                    type: 'POST',
                    url: '/divisi/edit',
                    cache: false,
